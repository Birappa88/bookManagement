...
const deleteReview = async function (req, res) {
  try {
    ...
    await reviewModel.findOneAndUpdate({ _id: reviewId, bookId:bookId, isDeleted:false}, { isDeleted: true, deletedAt: new Date() }, { new: true })
    
    const totalReview = await reviewModel.find({ bookId: bookId, isDeleted: false }).count()
    
    await bookModel.findOneAndUpdate({ _id: bookId, isDeleted: false }, { reviews: totalReview })
